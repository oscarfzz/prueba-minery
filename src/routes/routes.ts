...
const models: TsoaRoute.Models = {
    ...
    "DeliveryRequest": {
        "dataType": "refObject",
        "properties": {
            "delivery_ids": {"dataType":"array","array":{"dataType":"double"},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Product": {
        ...
        "properties": {
            "id": {"dataType":"double","required":true},
            "name": {"dataType":"string","required":true},
            "warehouses": {"dataType":"array","array":{"dataType":"string"},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "CreateProductRequest": {
        ...
        "properties": {
            "name": {"dataType":"string","required":true},
            "warehouseIds": {"dataType":"array","array":{"dataType":"double"},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "Delivery": {
        ...
        "properties": {
            ...
            "productsIds": {"dataType":"array","array":{"dataType":"double"},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/warehouses',
            ...
            ...(fetchMiddlewares<RequestHandler>(WarehouseController.prototype.createWarehouse)),

            async function WarehouseController_createWarehouse(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"CreateWarehouseRequest"},
            };
        ...
        app.get('/warehouses',
            ...(fetchMiddlewares<RequestHandler>(WarehouseController)),
            ...(fetchMiddlewares<RequestHandler>(WarehouseController.prototype.getWarehouses)),

            async function WarehouseController_getWarehouses(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
        ...
        app.post('/deliveries',
            ...
            ...(fetchMiddlewares<RequestHandler>(DeliveryController.prototype.createDelivery)),

            async function DeliveryController_createDelivery(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"CreateDeliveryRequest"},
            };
        ...
        app.get('/deliveries',
            ...(fetchMiddlewares<RequestHandler>(DeliveryController)),
            ...(fetchMiddlewares<RequestHandler>(DeliveryController.prototype.getDeliveries)),

            async function DeliveryController_getDeliveries(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
